...
class Items_List {
	...
	protected static function post_types_table() {
		...
		<h2 class="wp-heading-inline"><?php esc_html_e( 'Post Types', 'dt-the7-post-types' ) ?></h2>
		<a href="<?php echo esc_url( Admin_Page::get_post_type_link( Admin_Page::ACTION_NEW ) ) ?>" class="page-title-action"><?php esc_html_e( 'Add new', 'dt-the7-post-types' ) ?></a>

		<table class="wp-list-table widefat fixed striped table-view-list">
			<thead>
			<tr>
				<th scope="col" class="manage-column column-primary"><?php esc_html_e( 'Title', 'dt-the7-post-types' ) ?></th>
				<th scope="col" class="manage-column"><?php esc_html_e( 'Taxonomies', 'dt-the7-post-types' ) ?></th>
			</tr>
			</thead>
			...
			?>
				...
				<tr>
					<td class="title column-title has-row-actions column-primary" data-colname="Title">
						...
						if ( $is_disabled ) {
							$actions = [
								'activate' => '<a href="' . Post_Types_Handler::nonce_url( Admin_Page::get_post_type_link( Admin_Page::ACTION_ACTIVATE, $post_type['name'] ) ) . '" aria-label="">' . esc_html__( 'Activate', 'dt-the7-post-types' ) . '</a>',
							];
						} else {
							$actions = [
								'edit' => '<a href="' . esc_url( Admin_Page::get_post_type_link( Admin_Page::ACTION_EDIT, $post_type['name'] ) ) . '" aria-label="' . esc_attr( sprintf( esc_html__( 'Edit %s', 'dt-the7-post-types' ), $title ) ) . '">' . esc_html__( 'Edit', 'dt-the7-post-types' ) . '</a>',
							];

							if ( $post_type['public'] && $post_type['show_ui'] ) {
								$actions['view'] = '<a href="' . esc_url( admin_url( 'edit.php?post_type=' . $post_type['name'] ) ) . '" aria-label="' . esc_attr( sprintf( esc_html__( 'View %s post type', 'dt-the7-post-types' ), $title ) ) . '">' . esc_html__( 'View', 'dt-the7-post-types' ) . '</a>';
							}

							if ( $is_predefined ) {
								$actions['delete'] = '<a href="' . Post_Types_Handler::nonce_url( Admin_Page::get_post_type_link( Admin_Page::ACTION_DISABLE, $post_type['name'] ) ) . '" aria-label="">' . esc_html__( 'Deactivate', 'dt-the7-post-types' ) . '</a>';
							} else {
								$actions['delete'] = '<a href="' . Post_Types_Handler::nonce_url( Admin_Page::get_post_type_link( Admin_Page::ACTION_DELETE, $post_type['name'] ) ) . '" aria-label="">' . esc_html__( 'Delete', 'dt-the7-post-types' ) . '</a>';
							}
						}
	...
	protected static function taxonomies() {
		...
		<h2 class="wp-heading-inline"><?php esc_html_e( 'Taxonomies', 'dt-the7-post-types' ) ?></h2>
		<a href="<?php echo esc_url( Admin_Page::get_taxonomy_link( Admin_Page::ACTION_NEW ) ) ?>" class="page-title-action"><?php esc_html_e( 'Add new', 'dt-the7-post-types' ) ?></a>

		<table class="wp-list-table widefat fixed striped table-view-list">
			<thead>
			<tr>
				<th scope="col" class="manage-column column-primary"><?php esc_html_e( 'Title', 'dt-the7-post-types' ) ?></th>
				<th scope="col" class="manage-column"><?php esc_html_e( 'Post Types', 'dt-the7-post-types' ) ?></th>
			</tr>
			</thead>
			...
			?>
				...
				<tr>
					<td class="title column-title has-row-actions column-primary page-title" data-colname="Title">
						...
						<?php
						$actions = [
							'edit' => '<a href="' . esc_url( Admin_Page::get_taxonomy_link( Admin_Page::ACTION_EDIT, $taxonomy['name'] ) ) . '" aria-label="' . esc_attr( sprintf( esc_html__( 'Edit %s', 'dt-the7-post-types' ), $title ) ) . '">' . esc_html__( 'Edit', 'dt-the7-post-types' ) . '</a>',
						];

						if ( ! $is_predefined ) {
							$actions['delete'] = '<a href="' . Post_Types_Handler::nonce_url( Admin_Page::get_taxonomy_link( Admin_Page::ACTION_DELETE, $taxonomy['name'] ) ) . '" aria-label="">' . esc_html__( 'Delete', 'dt-the7-post-types' ) . '</a>';
						}
