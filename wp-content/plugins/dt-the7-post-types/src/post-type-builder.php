...
use The7_Post_Types\Utility\Rewrite_Rules_Flusher;
...
class Post_Type_Builder {
	...
	function get_preserved_labels() {
		return [
			'post_types' => [
				'singular' => [
					'add_new_item' => __( 'Add new %s', 'dt-the7-post-types' ),
					'edit_item'    => __( 'Edit %s', 'dt-the7-post-types' ),
					'new_item'     => __( 'New %s', 'dt-the7-post-types' ),
					'view_item'    => __( 'View %s', 'dt-the7-post-types' ),
				],
				'plural' => [
					'view_items'         => __( 'View %s', 'dt-the7-post-types' ),
					'all_items'          => __( 'All %s', 'dt-the7-post-types' ),
					'search_items'       => __( 'Search %s', 'dt-the7-post-types' ),
					'not_found'          => __( 'No %s found.', 'dt-the7-post-types' ),
					'not_found_in_trash' => __( 'No %s found in trash.', 'dt-the7-post-types' ),
				],
			],
			'taxonomies' => [
				'singular' => [
					'parent_item'       => __( 'Parent %s', 'dt-the7-post-types' ),
					'parent_item_colon' => __( 'Parent %s:', 'dt-the7-post-types' ),
					'edit_item'         => __( 'Edit %s', 'dt-the7-post-types' ),
					'update_item'       => __( 'Update %s', 'dt-the7-post-types' ),
					'add_new_item'      => __( 'Add new %s', 'dt-the7-post-types' ),
					'new_item_name'     => __( 'New %s name', 'dt-the7-post-types' ),
				],
				'plural' => [
					'search_items'               => __( 'Search %s', 'dt-the7-post-types' ),
					'popular_items'              => __( 'Popular %s', 'dt-the7-post-types' ),
					'all_items'                  => __( 'All %s', 'dt-the7-post-types' ),
					'separate_items_with_commas' => __( 'Separate %s with commas', 'dt-the7-post-types' ),
					'add_or_remove_items'        => __( 'Add or remove %s', 'dt-the7-post-types' ),
					'choose_from_most_used'      => __( 'Choose from the most used %s', 'dt-the7-post-types' ),
				],
			],
		];
	}
