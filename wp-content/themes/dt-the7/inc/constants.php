...
if ( ! defined( 'PRESSCORE_DB_VERSION' ) ) {
	define( 'PRESSCORE_DB_VERSION', '14.2.1' );
}

if ( ! defined( 'PRESSCORE_FSE_VERSION' ) ) {
	define( 'PRESSCORE_FSE_VERSION', '4' );
}

if ( ! defined( 'PRESSCORE_STYLESHEETS_VERSION' ) ) {
	define( 'PRESSCORE_STYLESHEETS_VERSION', '14.2.1.1' );
}

define( 'THE7_CORE_COMPATIBLE_VERSION', '2.7.10' );
...
if ( ! defined( 'PRESSCORE_DIR' ) ) {
	define( 'PRESSCORE_DIR', trailingslashit( PRESSCORE_THEME_DIR ) . basename( __DIR__ ) );
}

if ( ! defined( 'PRESSCORE_URI' ) ) {
	define( 'PRESSCORE_URI', trailingslashit( PRESSCORE_THEME_URI ) . basename( __DIR__ ) );
}
